...
public class Utils {
    ...
    public static SpriteDrawable getDrawable(Resource resource) {
        SpriteDrawable spriteDrawable = new SpriteDrawable(new Sprite(getTextureWithFilter(resource)));
        return spriteDrawable;
    }

    public static Sound getSound(Resource resource) {
        return Game.getInstance().getAssetManager().get(resource.getPath(), Sound.class);
    }

    public static Music getMusic(Resource resource) {
    ...
    public static Texture getTexture(Resource resource) {
        return Game.getInstance().getAssetManager().get(resource.getPath(), Texture.class);
    }

    public static Texture getTextureWithFilter(Resource resource) {
        Texture texture = Game.getInstance().getAssetManager().get(resource.getPath(), Texture.class);
