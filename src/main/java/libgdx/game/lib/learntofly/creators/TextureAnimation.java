...
public class TextureAnimation {
    ...
    public TextureAnimation(Resource resource, String animationKey, List<Integer> frameToPlay, int tileWidth, int tileHeight) {
        Texture texture = Utils.getTextureWithFilter(resource);
