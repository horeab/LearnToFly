...
public class CreateFinishPopup {
    ...
    public CreateFinishPopup(TextureRegion[] font, PlayerAttrs playerAttrs) {
        ...
        incrementCounterFullTexture = Utils.getTextureWithFilter(Resource.increment_full);
        incrementCounterRecordTexture = Utils.getTextureWithFilter(Resource.increment_record);
        incrementCounterEmpty = new TextureRegion(Utils.getTextureWithFilter(Resource.increment_empty), 0, 0, getMaxCounter(), 20);
        incrementCounterBorder = new TextureRegion(Utils.getTextureWithFilter(Resource.increment_empty), 0, 0, getMaxCounter() + BORDER_MARGIN, 20 + BORDER_MARGIN);
